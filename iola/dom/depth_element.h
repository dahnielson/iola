...
#ifndef IOLA_DOM_DEPTH_ELEMENT_H
#define IOLA_DOM_DEPTH_ELEMENT_H
...
{
public:
	depth_element(const std::string strName);
	...
	void restore(iola::model::iaudio_settings* object);
...
#endif // IOLA_DOM_DEPTH_ELEMENT_H
