...
#ifndef IOLA_DOM_MEDIA_ELEMENT_H
#define IOLA_DOM_MEDIA_ELEMENT_H
...
{
public:
	media_element(const std::string strName);
...
private:
	...
	video_element* m_pkVideo;
	audio_element* m_pkAudio;
};

} // namespace dom
} // namespace iola

#endif // IOLA_DOM_MEDIA_ELEMENT_H
