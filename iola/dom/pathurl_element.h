...
#ifndef IOLA_DOM_PATHURL_ELEMENT_H
#define IOLA_DOM_PATHURL_ELEMENT_H
...
{
public:
	pathurl_element(const std::string strName);
	...
	void restore(iola::model::ifile* object);
...
#endif // IOLA_DOM_PATHURL_ELEMENT_H
