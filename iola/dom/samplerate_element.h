...
#ifndef IOLA_DOM_SAMPLERATE_ELEMENT_H
#define IOLA_DOM_SAMPLERATE_ELEMENT_H
...
{
public:
	samplerate_element(const std::string strName);
...
#endif // IOLA_DOM_SAMPLERATE_ELEMENT_H
